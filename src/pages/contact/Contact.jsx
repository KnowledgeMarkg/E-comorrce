      ...
      <div className="container my-12 mx-auto px-2 md:px-4">
        <section className="mb-16">
          <div className="flex justify-center">
            <div className="text-center md:max-w-xl lg:max-w-3xl">
              <h2
                ...
                className="mb-12 px-6 text-3xl font-bold"
              >
                Contact us
              </h2>
            </div>
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12 mt-12">
              <div className="flex flex-wrap">
        ...
        <div
          id="map"
          className="relative h-[600px] overflow-hidden bg-cover bg-[50%] bg-no-repeat mb-6"
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11672.945750644447!2d-122.42107853750231!3d37.7730507907087!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858070cc2fbd55%3A0xa71491d736f62d5c!2sGolden%20Gate%20Bridge!5e0!3m2!1sen!2sus!4v1619524992238!5m2!1sen!2sus"
            className="w-full h-4/5 border-orange-900 border-4 rounded-3xl"
            allowfullscreen=""
            loading="lazy"
          ></iframe>
        </div>
